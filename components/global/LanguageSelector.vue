...
const getFlagSvg = (code: string) => {
  const flags: Record<string, string> = {
    'en': `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-gb" viewBox="0 0 640 480" width="20" height="20"><path fill="#012169" d="M0 0h640v480H0z"/><path fill="#FFF" d="m75 0 244 181L562 0h78v62L400 241l240 178v61h-80L320 301 81 480H0v-60l239-178L0 64V0z"/><path fill="#C8102E" d="m424 281 216 159v40L369 281zm-184 20 6 35L54 480H0zM640 0v3L391 191l2-44L590 0zM0 0l239 176h-60L0 42z"/><path fill="#FFF" d="M241 0v480h160V0zM0 160v160h640V160z"/><path fill="#C8102E" d="M0 193v96h640v-96zM273 0v480h96V0z"/></svg>`,
    '': `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icons-pt" viewBox="0 0 640 480" width="20" height="20">
  ...
  <g transform="translate(0 26.7)scale(1.06667)">
    ...
    'es': `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-es" viewBox="0 0 640 480" width="20" height="20">
  ...
  <path fill="none" d="M279.1 217v-1m-.6 1v-1m-.4 1.1V216"/>
    ...
    'fr': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="20" height="20"><rect width="300" height="600" fill="#002654"/><rect x="300" width="300" height="600" fill="#fff"/><rect x="600" width="300" height="600" fill="#ED2939"/></svg>`,
    'it': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="20" height="20"><rect width="300" height="600" fill="#009246"/><rect x="300" width="300" height="600" fill="#fff"/><rect x="600" width="300" height="600" fill="#CE2B37"/></svg>`,
    'de': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="20" height="20"><rect width="900" height="200" fill="#000000"/><rect y="200" width="900" height="200" fill="#DD0000"/><rect y="400" width="900" height="200" fill="#FFCE00"/></svg>`,
    'zh-CN': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="20" height="20">
  <!-- Red background -->
  <rect width="900" height="600" fill="#DE2910"/>
  
  <!-- Large star (upper left quadrant) -->
  <g transform="translate(180,150)">
    <path fill="#FFDE00" stroke="#FFDE00" stroke-width="1" d="M0,-60 L18.5,-18.5 L60,-18.5 L24,5 L36,47 L0,24 L-36,47 L-24,5 L-60,-18.5 L-18.5,-18.5 Z"/>
  </g>
  
  <!-- Four smaller stars arranged in an arc pointing toward the large star -->
  <!-- Star 1 (top) -->
  <g transform="translate(360,100) rotate(-14)">
    <path fill="#FFDE00" d="M0,-24 L7.4,-7.4 L24,-7.4 L9.6,2 L14.4,19.2 L0,9.6 L-14.4,19.2 L-9.6,2 L-24,-7.4 L-7.4,-7.4 Z"/>
  </g>
  
  <!-- Star 2 (upper middle) -->
  <g transform="translate(390,130) rotate(-7)">
    <path fill="#FFDE00" d="M0,-24 L7.4,-7.4 L24,-7.4 L9.6,2 L14.4,19.2 L0,9.6 L-14.4,19.2 L-9.6,2 L-24,-7.4 L-7.4,-7.4 Z"/>
  </g>
  
  <!-- Star 3 (lower middle) -->
  <g transform="translate(390,170) rotate(7)">
    <path fill="#FFDE00" d="M0,-24 L7.4,-7.4 L24,-7.4 L9.6,2 L14.4,19.2 L0,9.6 L-14.4,19.2 L-9.6,2 L-24,-7.4 L-7.4,-7.4 Z"/>
  </g>
  
  <!-- Star 4 (bottom) -->
  <g transform="translate(360,200) rotate(14)">
    <path fill="#FFDE00" d="M0,-24 L7.4,-7.4 L24,-7.4 L9.6,2 L14.4,19.2 L0,9.6 L-14.4,19.2 L-9.6,2 L-24,-7.4 L-7.4,-7.4 Z"/>
  </g>
</svg>`
  };
  return flags[code] || flags[''];
};
...
<template>
  ...
  <div class="relative inline-block text-left py-4 mr-2 w-full" @click="closeNopenDropdown()">
    ...
    <div class="inline-flex items-center cursor-pointer">
      <span v-html="getCurrentFlagSvg()" class="w-5 h-5 inline-block"></span>
    ...
    <div ref="dropdownRef" v-if="dropdownOpen">
      <ul class="absolute top-8 mt-2 w-22 sm:w-32 bg-white rounded-md shadow-lg z-20 py-1 left-[-35px] sm:left-[-80px] xl:left-[-50px] font-semibold text-sm">
        <li v-for="lang in languages" :key="lang.code" @click="changeLanguage(lang.code)" class="text-[#3b4249] hover:text-[#b53d3d] flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 cursor-pointer">
          <span v-html="getFlagSvg(lang.code)" class="w-5 h-5 mr-2 inline-block"></span>
