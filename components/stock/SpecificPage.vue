...
<template>
  ...
  <div v-else class="bg-[#121212] p-4 sm:p-10 lg:p-2 xl:p-10 pt-2 sm:pt-12 xl:pt-20">
    ...
    <div class="flex flex-col lg:flex-row lg:items-stretch justify-center rounded-xl">
      ...
      <div class="desktop-swiper-panel w-full lg:w-2/5 xl:w-1/2 bg-[#201818] rounded-r-xl hidden lg:flex flex-col sm:flex-row justify-center items-center relative">
        <div
          v-if="!isImageAreaReady"
